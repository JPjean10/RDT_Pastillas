...
public interface GlucosaLocalDao {
    ...
    @Query("SELECT * FROM (SELECT * FROM GlucosaEntity WHERE id_usuario = :idUsuario ORDER BY fecha_hora_creacion DESC LIMIT 7 OFFSET :offset) ORDER BY fecha_hora_creacion ASC")
